# mccoy
sudo sshfs -o reconnect,idmap=user,transform_symlinks,identityFile=~/.ssh/id_rsa,allow_other,cache=yes,kernel_cache,compression=no,default_permissions,uid=1000,gid=100,umask=0 patrick@141.35.159.150:/ /mnt/mccoy

# unstrut
sudo mount -t cifs -o credentials=/home/pjs/.smbcredentials.txt,uid=1000,file_mode=0775,dir_mode=0775,gid=100,sec=ntlm,vers=1.0,dom=ads.uni-jena.de,forcegid //141.35.159.70/home_geoinf     /mnt/geoinf_home

# unstrut
sudo mount -t cifs -o credentials=/home/pjs/.smbcredentials.txt,uid=1000,file_mode=0775,dir_mode=0775,gid=100,sec=ntlm,vers=1.0,dom=ads.uni-jena.de,forcegid //141.35.159.70/home_web     /mnt/geoinf_web

# lossa
sudo mount -t cifs -o credentials=/home/pjs/.smbcredentials.txt,uid=1000,file_mode=0775,dir_mode=0775,gid=100,sec=ntlm,vers=1.0,dom=ads.uni-jena.de,forcegid //141.35.159.90/data     /mnt/lossa
